    ...
    return (
        <div className='tutorial-house'>
            ...
            <div className='tutorial-text'>
                ...
                <p>The details of this case are available in the documents given to you in your backpack.</p>
                <p>As a detective you have access to a backpack, which has a max capacity of 4 items, so choose what you carry wisely! Click the backpack icon to open your backpack, then click any item within the pack to examine it. Click the ' - ' to drop an item. To close the pack, click the backpack icon again.</p>
